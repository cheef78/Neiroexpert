def GR_Loko_Force (VSP_type, Condition, Radius, h, V, Sh_Kol, mu_fr,Show_or_return = "return"):
...
GR_Loko_Force (1, 1, 250, 140, 80, 1520, 0.25, 'show')
print (GR_Loko_Force (1, 1, 250, 140, 80, 1520, 0.25, 'return'))
